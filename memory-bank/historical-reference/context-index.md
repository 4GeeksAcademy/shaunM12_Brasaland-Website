...
- `context-28-milestone-10-real-time-systems-sse-p1.md` — **Milestone 10 Part 1:** RFP SSE notifications — `GET /rfp/events/stream`, in-memory pub/sub, refetch-then-SSE, `/rfp` UI (locked 2026-08-07; Part 2 WebSocket chat is separate branch)
...
- `context-28` is reserved for Milestone 10 real-time systems: Part 1 SSE RFP notifications (`-sse-p1`); Part 2 WebSocket support chat streaming (companion file TBD on separate branch).
