...
The `incidents-brasaland.csv` file has been sent as an attachment (see `incidents-brasaland.csv`). The following values describe its contents and are what your script must produce exactly.
