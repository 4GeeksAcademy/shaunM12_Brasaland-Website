    ...
    <form onSubmit={handleSubmit} className="space-y-3 rounded-xl border border-amber-200/20 bg-stone-900/85 p-4 shadow-2xl shadow-black/20">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <label className="text-sm text-amber-100">
          Full name
          <input
            className="mt-1 w-full rounded-xl border border-stone-600 bg-stone-950/90 px-3 py-2 text-amber-100 placeholder-stone-400 focus:border-amber-300 focus:ring-4 focus:ring-amber-300/20 outline-none transition"
        ...
        <label className="text-sm text-amber-100">
          Status
          <select
            className="mt-1 w-full rounded-xl border border-stone-600 bg-stone-950/90 px-3 py-2 text-amber-100 focus:border-amber-300 focus:ring-4 focus:ring-amber-300/20 outline-none transition"
        ...
        <label className="text-sm text-amber-100 md:col-span-2">
          ...
          <input
            ...
            onChange={(event) =>
              onInputChange("experience_years", Number(event.target.value || 0))
            }
      ...
      <button
        ...
        className="rounded-md bg-amber-700 px-4 py-2 text-white disabled:opacity-60"
      >
