import { BrasaLocation, BrasaPointsRegistration } from "./types";
...
export function findLocationByName(locations: BrasaLocation[], locationName: string): BrasaLocation | null {
...
export function binarySearchLocationByName(sortedLocations: BrasaLocation[], targetLocationName: string): number {
