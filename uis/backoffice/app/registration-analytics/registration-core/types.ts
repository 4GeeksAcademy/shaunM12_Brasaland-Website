// Registration-analytics domain types.
//
// These are intentionally duplicated from the data-processing core so the two
// analytics modules stay fully decoupled and can evolve (and later be wired to
// their own APIs) independently.
